...
<ol class="index-list">
    ...
    <li><p>After making changes and saving the project, you can make the HTML export. Navigate to the
            <strong>Files</strong> menu item, choose <strong>Export as HTML...</strong>. Enter the sitename and the name
            of
            the folder where the export needs to be done. That's it!</p>
        <figure class="img-polaroid">
            <img src="img/muse-export.jpg" alt="">
        </figure>
    </li>
